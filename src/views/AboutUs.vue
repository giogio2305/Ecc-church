...
<div class="w-full min-h-screen bg-white m-0 p-0">
        ...
        <div class="flex flex-col md:flex-row items-center justify-start p-4 md:p-6 mt-20">
         ...
         <div class="flex flex-col items-start justify-start w-full md:w-[60%] md:ml-20 mt-12 md:mt-0">
            <h3 class="font-bold text-blue-500 text-base">À PROPOS DE NOUS</h3>
            <h1 class="font-bold my-6 text-slate-700 text-3xl md:text-5xl">Nous prenons de petites mesures pour rendre la Terre meilleure</h1>
            <hr class="bg-blue-500 w-[10%] h-2 my-3"/>
            ...
            <div class="py-1 my-3 w-full flex flex-col md:flex-row md:items-center justify-start">
                <div class="flex flex-col w-full md:w-[50%] p-4">
                    <span class="flex items-center justify-center my-2 w-16 h-16 bg-yellow-500 text-white rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mt-1 w-8 h-8">
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
    ...
    <div class="mx-auto w-[96%] min-h-[200px] bg-zinc-700/60 rounded-md mb-10"></div>


    <div class="w-full flex flex-col items-center justify-center my-16">
        <h3 class="font-bold text-blue-500 text-base">Notre équipe</h3>
            <h1 class="font-bold my-2 text-slate-700 text-3xl">Les pasteurs</h1>
            ...
            <div class="flex flex-col md:flex-row items-center justify-center my-16">
                <div class="w-[328px] h-[448px]   shadow-sm ">
                    ...
                    <div class="w-full flex flex-col items-center h-[20%] bg-blue-700 border-b-4 border-yellow-400 p-2">
                        ...
                        <p class="my-1 font-normal text-base text-slate-100">Clergé prostetant</p>
